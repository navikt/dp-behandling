...
class VernepliktTest {
    ...
    fun `valider oppførsel til erRelevant`() {
        ...
        regelsett.påvirkerResultat(opplysninger(true, true, false)) shouldBe true
        ...
        regelsett.påvirkerResultat(opplysninger(true, false, true)) shouldBe false

        // Oppfyller ikke verneplikt, minsteinntekt er oppfylt, ikke relevant
        regelsett.påvirkerResultat(opplysninger(false, false, true)) shouldBe false
    }
