...
object OpplysningsTyper {
    ...
    val BarnSomGirTilleggId = Opplysningstype.Id(UUID.fromString("019e2085-a97a-776b-ba2c-4bca8e01a166"), BarnDatatype)
    ...
    val permitteringsdagerIUkaId = Opplysningstype.Id(UUID.fromString("01a02334-b6e7-7565-878c-2b1e1e99e286"), Heltall)
    ...
    val ØnskerÅVæreRegistrertArbeidssøkerId = Opplysningstype.Id(UUID.fromString("019ffffa-05bf-7428-ba34-ef848dab0f39"), Boolsk)
    ...
    val framsattSøknadId = Opplysningstype.Id(UUID.fromString("019c091e-e7aa-7e15-b339-b6276276ebf2"), Boolsk)
    val ønskerDagpengerId = Opplysningstype.Id(UUID.fromString("019c0920-8b11-729a-866d-9f271f03ef2e"), Boolsk)
    ...
    val oppfyllerKravetTilPermitteringFraDatoId = Opplysningstype.Id(UUID.fromString("01a02331-3f5b-7751-82f0-0fc520cc8983"), Dato)
    ...
    val erSanksjonsdagId = Opplysningstype.Id(UUID.fromString("019df7e6-33bc-7daa-ad4e-46ba84c3cb49"), Boolsk)
    ...
    val innenforFritaksperiodenId = Opplysningstype.Id(UUID.fromString("01a03e0b-1dfa-7832-8ec7-a82c549895b4"), Boolsk)
    val manglerKravPåLønnId = Opplysningstype.Id(UUID.fromString("01a03e0b-1dfa-755c-9139-297e3db68a6d"), Boolsk)
}
