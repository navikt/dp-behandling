...
import no.nav.dagpenger.mediator.Behovssporer
import no.nav.dagpenger.mediator.Metrikk.tidBruktPerEndring
...
internal class ApiRepositoryPostgres(
    ...
    suspend fun endreOpplysning(
        ...
        behovssporer.behovSendt(behandlingId, listOf(behov), no.nav.dagpenger.mediator.Behovssporer.Kilde.Api)
