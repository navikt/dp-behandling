...
import no.nav.dagpenger.mediator.OpplysningSvarBygger
...
import no.nav.dagpenger.mediator.mottak.SvarStrategi.Svar
...
internal class OpplysningSvarMottak(
    ...
    private val skipBehandlingsId = listOf("019ea940-f072-7ca4-83ef-e603344e3c6b")
