...
import no.nav.dagpenger.behandling.mediator.repository.TestBehandlinger
...
class HendelseMediatorTest {
    ...
    fun foobar() {
        ...
        val hendelse = TestBehandlinger.lagTestHendelse("ident", søknadId = søknadId, gjelderDato = gjelderDato)
