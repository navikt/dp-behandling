...
import no.nav.dagpenger.mediator.TestOpplysningstyper.beløpB
import no.nav.dagpenger.mediator.TestOpplysningstyper.boolsk
import no.nav.dagpenger.mediator.TestOpplysningstyper.dato
import no.nav.dagpenger.mediator.TestOpplysningstyper.desimal
import no.nav.dagpenger.mediator.TestOpplysningstyper.heltall
import no.nav.dagpenger.mediator.TestOpplysningstyper.inntektA
import no.nav.dagpenger.mediator.TestOpplysningstyper.maksdato
import no.nav.dagpenger.mediator.TestOpplysningstyper.mindato
import no.nav.dagpenger.mediator.TestOpplysningstyper.opplysningerRepository
import no.nav.dagpenger.mediator.TestOpplysningstyper.periode
import no.nav.dagpenger.mediator.TestOpplysningstyper.tekst
import no.nav.dagpenger.mediator.TestOpplysningstyper.utledetOpplysningstype
