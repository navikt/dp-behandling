...
dependencies {
    ...
    implementation("com.github.navikt.tbd-libs:naisful-app:2025.03.06-15.24-78935db9")
    ...
    testImplementation("com.github.navikt.tbd-libs:naisful-test-app:2025.03.06-15.24-78935db9")
