...
graph RL
  ...
  J["Antall timer arbeidstiden skal samordnes mot"] -->|"Oppslag"| B["Prøvingsdato"]
  K["Samordnet fastsatt arbeidstid"] -->|"Substraksjon"| L["Beregnet vanlig arbeidstid per uke før tap"]
  K["Samordnet fastsatt arbeidstid"] -->|"Substraksjon"| J["Antall timer arbeidstiden skal samordnes mot"]
  M["Sykepenger dagsats"] -->|"Oppslag"| B["Prøvingsdato"]
  N["Pleiepenger dagsats"] -->|"Oppslag"| B["Prøvingsdato"]
  O["Omsorgspenger dagsats"] -->|"Oppslag"| B["Prøvingsdato"]
  P["Opplæringspenger dagsats"] -->|"Oppslag"| B["Prøvingsdato"]
  Q["Uføre dagsats"] -->|"Oppslag"| B["Prøvingsdato"]
  R["Svangerskapspenger dagsats"] -->|"Oppslag"| B["Prøvingsdato"]
  S["Foreldrepenger dagsats"] -->|"Oppslag"| B["Prøvingsdato"]
  T["Sum hvis Uføre ikke skal samordnes"] -->|"Oppslag"| B["Prøvingsdato"]
  U["Uførebeløp som skal samordnes"] -->|"HvisSannMedResultat"| I["Uføretrygden er gitt med virkningstidspunkt i inneværende år eller innenfor de to siste kalenderår"]
  U["Uførebeløp som skal samordnes"] -->|"HvisSannMedResultat"| Q["Uføre dagsats"]
  U["Uførebeløp som skal samordnes"] -->|"HvisSannMedResultat"| T["Sum hvis Uføre ikke skal samordnes"]
  V["Sum andre ytelser"] -->|"Addisjon"| M["Sykepenger dagsats"]
  V["Sum andre ytelser"] -->|"Addisjon"| N["Pleiepenger dagsats"]
  V["Sum andre ytelser"] -->|"Addisjon"| O["Omsorgspenger dagsats"]
  V["Sum andre ytelser"] -->|"Addisjon"| P["Opplæringspenger dagsats"]
  V["Sum andre ytelser"] -->|"Addisjon"| U["Uførebeløp som skal samordnes"]
  V["Sum andre ytelser"] -->|"Addisjon"| S["Foreldrepenger dagsats"]
  V["Sum andre ytelser"] -->|"Addisjon"| R["Svangerskapspenger dagsats"]
  ...
  W["Samordnet dagsats uten barnetillegg"] -->|"Substraksjon"| V["Sum andre ytelser"]
  ...
  Y["Samordnet dagsats er større enn 0"] -->|"StørreEnnEllerLik"| V["Sum andre ytelser"]
