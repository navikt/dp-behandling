...
graph RL
  ...
  E["Ingen egenandel"] -->|"Oppslag"| B["Prøvingsdato"]
  F["Egenandel"] -->|"HvisSannMedResultat"| G["Oppfyller kravet til permittering i fiskeindustrien"]
  F["Egenandel"] -->|"HvisSannMedResultat"| E["Ingen egenandel"]
  F["Egenandel"] -->|"HvisSannMedResultat"| C["Tre ganger dagsats"]
```
