...
graph RL
  ...
  D["Oppfyller unntak for opphold i Norge"] -->|"Utgangspunkt"| C["Bruker oppholder seg i Norge"]
  E["Oppfyller kravet til opphold i Norge eller unntak"] -->|"EnAv"| C["Bruker oppholder seg i Norge"]
  E["Oppfyller kravet til opphold i Norge eller unntak"] -->|"EnAv"| D["Oppfyller unntak for opphold i Norge"]
  F["Oppfyller kravet til medlemskap"] -->|"ErSann"| G["Bruker er medlem av folketrygden"]
  H["Kravet til opphold i Norge er oppfylt"] -->|"Alle"| E["Oppfyller kravet til opphold i Norge eller unntak"]
