...
graph RL
  ...
  C["Registrert som arbeidssøker på søknadstidspunktet"] -->|"EnAv"| A["Registrert som arbeidssøker"]
  C["Registrert som arbeidssøker på søknadstidspunktet"] -->|"EnAv"| D["Har rimelig grunn til å ikke være registrert som arbeidssøker"]
```
