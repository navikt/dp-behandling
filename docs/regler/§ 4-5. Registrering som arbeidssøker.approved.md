...
```mermaid
graph RL
  A["Registrert som arbeidssøker"] -->|"Ekstern"| B["Vurder rett fra og med"]
  C["Ønsker å være registrert som arbeidssøker"] -->|"Utgangspunkt"| B["Vurder rett fra og med"]
  D["Oppfyller kravet til å være registrert som arbeidssøker"] -->|"Alle"| A["Registrert som arbeidssøker"]
  D["Oppfyller kravet til å være registrert som arbeidssøker"] -->|"Alle"| C["Ønsker å være registrert som arbeidssøker"]
```
